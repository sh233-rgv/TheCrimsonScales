...
public class EarthDemonAbilityCard3 : EarthDemonAbilityCard
{
	...
	[
		new MonsterAbilityCardAbility(AttackAbility(monster, +0)
			.WithRange(4)
			.WithTargets(new DynamicInt(() => CheckElementConsumed(monster, [Element.Earth]) ? 2 : 1))
			.Build())
	];
...
public class EarthDemonAbilityCard5 : EarthDemonAbilityCard
{
	...
	[
		...
		new MonsterAbilityCardAbility(AttackAbility(monster, -1)
			.WithTarget(Target.Enemies | Target.TargetAll)
			.WithDuringAttackSubscription(ConsumeElementCheckSubscription<ScenarioEvents.DuringAttack.Parameters>(monster, [Element.Earth],
...
public class EarthDemonAbilityCard6 : EarthDemonAbilityCard
{
	...
	[
		...
		new MonsterAbilityCardAbility(AttackAbility(monster,
				new DynamicInt<AttackAbility.State>(_ => CheckElementConsumed(monster, [Element.Air]) ? -2 : +0))
			.Build()),
	];
