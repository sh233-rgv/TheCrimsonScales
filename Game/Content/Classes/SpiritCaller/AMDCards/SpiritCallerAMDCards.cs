...
{
	public class MinusOne : SpiritCallerAMDCardModel
	{
		protected override int AtlasIndex => 0;
		public override int? GetValue(AttackAbility.State attackAbilityState) => -1;
	}

	public class PlusOne : SpiritCallerAMDCardModel
	{
	...
	public class PlusZeroPlusTwoIfSpiritAttacked : SpiritCallerAMDCardModel
	{
		public override string ToString(RichTextParameters richTextParameters) =>
			GetBasicString(richTextParameters, +0,
				extraText:
				$"If a Spirit attacked, {Icons.Inline(Icons.GetAMDValue("+2"), richTextParameters)} instead");
