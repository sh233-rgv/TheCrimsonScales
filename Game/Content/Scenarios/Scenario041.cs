...
public class Scenario041 : ScenarioModel
{
	...
	protected override ScenarioGoals CreateScenarioGoals() => new KillSpecificEnemiesTypeGoals(ModelDB.Monster<RogueHollowpact>(), "Kill the Rogue Hollowpact to win this scenario.");
	...
	protected override async GDTask OnRoomRevealed(ScenarioEvents.RoomRevealed.Parameters parameters)
	{
		...
		ScenarioCheckEvents.CanEnterMapTileCheckEvent.Subscribe(this,
