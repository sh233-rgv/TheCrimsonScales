...
public class Scenario046 : ScenarioModel
{
	...
	public override async GDTask StartAfterFirstRoomRevealed()
	{
		...
		UpdateScenarioText(
			$"The bushes marked {Icons.Inline(Icons.GetMarker(Marker.Type.a))} are the Bushes of Hope and cannot be destroyed. Whenever a figure adjacent to a Bush of Hope draws a negative modifier, treat it as a {Icons.Inline(Icons.GetAMDValue("+0"))} instead.");
		...
		_treeOfHope.Init(GameController.Instance.SavedCampaign.Characters.Count * (ScenarioLevel + 5), "Tree of Death");
