...
// 		where T : ScenarioEvent.IParameters
// 	{
...
// 		if(type.IsValueType || type.InheritsFrom(typeof(IAbilitySource)) || type.InheritsFrom(typeof(MemberInfo)) || type.InheritsFrom(typeof(Assembly)) || type.InheritsFrom(typeof(Module)))
// 		{
// 			return true;
// 		}
//
