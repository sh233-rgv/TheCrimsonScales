...
public class SavedCampaign
{
	...
	public static SavedCampaign Test()
	{
		...
		//savedCampaign.AddCharacter(ModelDB.Class<LuminaryModel>(), ModelDB.PersonalQuest<ExperiencedLeader>(), "Sterrenwerper");
		//savedCampaign.AddCharacter(ModelDB.Class<BrightsparkModel>(), null, "Ruineerkaak");
