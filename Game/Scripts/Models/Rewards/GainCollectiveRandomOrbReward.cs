...
public class GainCollectiveRandomOrbReward : SavedReward
{
	public override RewardType Type => RewardType.Immediate;

	public GainCollectiveRandomOrbReward()
	{
	}

	public override string GetLabelText(RichTextParameters textParameters) => $"Gain one collective random “Orb” item.";
