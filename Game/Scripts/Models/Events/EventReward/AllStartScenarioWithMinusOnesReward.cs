...
public class AllStartScenarioWithMinusOnesReward(int number) : EventReward
{
	public override EventRewardType Type => EventRewardType.ScenarioStart;

	public override string GetLabelText(Color textColor) => $"All characters start the next scenario with {Icons.Inline(Icons.MinusOneCard)} x{number}.";
