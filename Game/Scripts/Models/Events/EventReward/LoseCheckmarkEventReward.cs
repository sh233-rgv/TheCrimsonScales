...
public class LoseCheckmarkEventReward() : EventReward
{
	public override EventRewardType Type => EventRewardType.Immediate;
	public override string GetLabelText(Color textColor) => $"Lose 1 {Icons.Inline(Icons.Checkmark, color: textColor)} each.";
