...
public static class GTweenGodotExtensions
{
    ...
    public static GTween Play(this GTween tween)
    {
    ...
    public static GTween Play(this GTween tween, bool instantly)
    {
        tween.Play();
    ...
    // public static IEnumerator<double> WaitForCompletion(this GTween gTween)
    // {
    //     bool complete;
    //     gTween.OnCompleteOrKill(() => complete = true);
